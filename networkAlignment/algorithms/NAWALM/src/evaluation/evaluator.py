...
from algorithms.MUSE.src.evaluation import get_wordsim_scores, get_crosslingual_wordsim_scores, get_wordanalogy_scores
from algorithms.MUSE.src.evaluation import get_word_translation_accuracy
from algorithms.MUSE.src.evaluation import load_europarl_data, get_sent_translation_accuracy
from algorithms.MUSE.src.dico_builder import get_candidates, build_dictionary
from algorithms.MUSE.src.utils import get_idf
import torch
import numpy as np
...
class Evaluator(object):
    ...
    def eval_dis(self, to_log):
        ...
        for i in range(0, self.src_emb.num_embeddings, bs):
            # emb = (self.src_emb.weight[i:i + bs].data, volatile=True)
