...
from algorithms.MUSE.src.utils import load_embeddings, normalize_embeddings
...
class Mapping(nn.Module):
    def __init__(self, params):
        ...
        self.emb_dim = params.emb_dim
        self.layer = nn.Linear(params.emb_dim, params.emb_dim, bias=False)
...
def build_model(params, with_dis):
    ...
    print("Actual embedding dim is: ", params.emb_dim)
